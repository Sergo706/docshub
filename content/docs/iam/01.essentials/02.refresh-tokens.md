...
| `prevTs` | `Date | undefined` | The previous timestamp of the session to set in the db, defaults to `UTC_TIMESTAMP()` |
...
```
requireRefreshToken, acceptCookieOnly, getFingerPrint, rotateCredentials
```
